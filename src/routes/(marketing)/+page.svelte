		...
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			<div class="mx-auto max-w-2xl text-center">
				...
				<p class="mt-6 text-lg leading-8 text-gray-600">
					Discover the Ultimate Mom-Approved Playdate Solution: Connecting Moms, Creating Memories!
				</p>
		...
		<FeaturesList
			features={[
				...
				},
				{
					title: 'SMS Messaging',
					description:
						'Allow sms reminders, no app required! Moms can receive update, and reminders without having to download another app',
					icon: 'chat',
				},
				{
					title: 'Availability',
				...
				{
					title: 'Easy Access',
					description: 'Share event links via SMS. No sign ups required to schedule',
					icon: 'stars',
				},
			]}
		/>
